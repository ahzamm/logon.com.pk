...
class ClientBenefitController extends Controller
{
    ...
    {
        $client_benefits = ClientBenefit::orderby('sortIds', 'asc')->get();
        return view('admin.client-benefits.index', compact('client_benefits'));
    }

    public function create(Request $request)
    {
        $icons = $this->icons;
        return view('admin.client-benefits.create', compact('icons'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $maxSortId = ClientBenefit::max('sortIds');
        $client_benefit = new ClientBenefit();
        $client_benefit->heading = $request->heading;
        $client_benefit->text = $request->text;
        $client_benefit->icon = $request->icon;
        $client_benefit->sortIds = $maxSortId !== null ? $maxSortId + 1 : 0;
        $client_benefit->save();

        return redirect()->route('client-benefit.index')->with('success', 'ClientBenefit Added successfully!');
    }

    public function edit(Request $request, $id)
    {
        $icons = $this->icons;
        $client_benefit = ClientBenefit::find($id);
        return view('admin.client-benefits.edit', compact('client_benefit', 'icons'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $client_benefit = ClientBenefit::findOrFail($id);
        $client_benefit->heading = $request->heading;
        $client_benefit->text = $request->text;
        $client_benefit->icon = $request->icon;
        $client_benefit->save();

        return redirect()->route('client-benefit.index')->with('success', 'ClientBenefit updated successfully!');
    }

    public function destroy(Request $request, $id)
    {
        ClientBenefit::find($id)->delete();
    ...
    public function sort(Request $request)
    {
        ...
        foreach ($sortIds as $key => $value) {
            $menu = ClientBenefit::find($value);
            if ($menu) {
                $menu->sortIds = $key;
                $menu->save();
            }
        }
        $frontValue = ClientBenefit::orderby('sortIds', 'asc')->get();
    ...
    public function change_status(Request $request)
    {
        ...
        $statusChange = ClientBenefit::where('id', $id)->update(['is_active' => $status]);
        if ($statusChange) {
