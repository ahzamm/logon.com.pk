            ...
            <div class="col-12">
                <div class="card mt-3">
                    <div class="card-header">
                      <h3 class="card-title">View All Core Areas</h3>
...
<script>
  ...
  $(document).on('click','.btnDeleteIP',function(){
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                {
                    alert('you don\'t delete it because core have zones');
                }
            }
        })
  })
  ...
  $(document).on('submit','#ipEditForm',function(e){
   ...
   let changeStatusUrl = "{{ route('corearea.status') }}";
          ...
          success: function(response) {
            if (response == "success") {
              Swal.fire({
                ...
                text: "Core Area Status Has been Changed!",
                animation: false,
