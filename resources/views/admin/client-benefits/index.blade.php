          ...
          <div class="col-12">
            <div class="card mt-3 card-outline card-info">
              <div class="card-header">
                <h3 class="card-title"><span><i class="fa fa-gears"></i></span> Client Benefits</h3>
                <a class="btn btn-success btn-sm float-right" href="{{ route('client-benefit.create') }}"><i class="fa fa-plus"></i> Add Client Benefit</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped" id="example">
                    ...
                    <tbody id="sortfrontMenu" class="move">
                      @foreach ($client_benefits as $key => $item)
                        <tr class="table-row">
                          ...
                          <td class="d-flex justify-content-center" style="gap: 5px;">
                            <a class="btn btn-primary btn-sm" href="{{ route('client-benefit.edit', $item->id) }}"><i class="fa fa-edit"></i></a>
                            <button class="btn btn-danger btn-sm btnDeleteClientBenefit" data-value="{{ $item->id }}"><i class="fa fa-trash"></i></button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
...
@push('scripts')
  ...
  <script>
    ...
    let changeStatusUrl = "{{ route('client-benefit.status') }}";
    ...
    $(document).on('click', '.btnDeleteClientBenefit', function() {
    ...
    let sortingFrontUrl = "{{ route('client-benefit.sort') }}";
