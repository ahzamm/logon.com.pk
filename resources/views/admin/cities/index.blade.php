            ...
            <div class="col-12">
                <div class="card mt-3 card-outline card-info">
                    <div class="card-header">
                      <h3 class="card-title">View All Cities </h3>
                    <a class="btn btn-success btn-sm float-right" href="{{route('cities.create')}}"><i class="fa fa-plus"></i></a>
                    <button class="btn btn-primary mr-2 btn-sm float-right" data-value="p" id="emailEditP">Edit Member Email</a>
                    <button class="btn btn-primary mr-2 btn-sm float-right" data-value="c" id="emailEditC">Edit Consumer Email</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($cities as $key=> $item)
                                    ...
                                    <td>{{++$key}}</td>
                                        ...
                                        <button class="btn btn-danger btn-sm btnDeleteCity" data-value="{{$item->id}}"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
  ...
  $(document).on('click','.btnDeleteCity',function(){
   ...
   let changeStatusUrl = "{{ route('citiy.status') }}";
          ...
          success: function(response) {
            if (response == "success") {
              Swal.fire({
                ...
                text: "City Status Has been Changed!",
                animation: false,
