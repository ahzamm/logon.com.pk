                  ...
                  @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="name"  value="{{$corporate->name}}">
                              @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="address"  value="{{$corporate->address}}">
                              @error('address')
                                  <p class="text-danger mt-2 mb-0 text-sm">{{$message}}</p>
                              @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="contact" value="{{$corporate->contact}}">
                              @error('contact')
                                  <p class="text-danger mt-2 mb-0 text-sm">{{$message}}</p>
                              @enderror
                            </div>
                            ...
                            <div class="form-group clearfix">
                              <label for="" style="visibility: hidden">A</label>
                                <div class="icheck-success">
                                  <input type="checkbox"  {{$corporate->status != null? 'checked' :'unchecked' }} name="status" id="checkboxSuccess1">
