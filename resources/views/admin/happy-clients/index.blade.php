          ...
          <div class="col-12">
            <div class="card mt-3 card-outline card-info">
              <div class="card-header">
                <h3 class="card-title"><span><i class="fa fa-gears"></i></span> Happy Clients</h3>
                <a class="btn btn-success btn-sm float-right" href="{{ route('happy-clients.create') }}"><i class="fa fa-plus"></i> Add Happy Client</a>
              </div>
              <div class="card-body">
                      ...
                      @foreach ($happy_clients as $key => $item)
                        <tr class="table-row">
                          ...
                          <td class="d-flex justify-content-center" style="gap: 5px;">
                            <a class="btn btn-primary btn-sm" href="{{ route('happy-clients.edit', $item->id) }}"><i class="fa fa-edit"></i></a>
                            <button class="btn btn-danger btn-sm btnDeleteHappyClient" data-value="{{ $item->id }}"><i class="fa fa-trash"></i></button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
...
@push('scripts')
  ...
  <script>
    ...
    let changeStatusUrl = "{{ route('happy-clients.status') }}";
        ...
        success: function(response) {
          if (response == "unauthorized") {
            ...
            Swal.fire({
              ...
              text: "Client Benefit Status Has been Changed!",
              animation: false,
    ...
    $(document).on('click', '.btnDeleteHappyClient', function() {
    ...
    let sortingFrontUrl = "{{ route('happy-clients.sort') }}";
