...
<body>
    <div class="wrapper">
        <h2 style="font-size: 26px;">Dear Member</h2>
        <p class="mail-detail">Please verify your Logon Home admin panel Account by entering this code <b>{{$code}}</b></p>
        <br>
        <p>Best Regards,</p>
        <p><b>Logon Broadband</b></p>
    </div>
</body>
</html>